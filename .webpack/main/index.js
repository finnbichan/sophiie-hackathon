...
var createWindow = function createWindow() {
  ...
  electron__WEBPACK_IMPORTED_MODULE_0__.session.defaultSession.webRequest.onHeadersReceived(filter, function (details, callback) {
    callback({
      responseHeaders: _objectSpread(_objectSpread({}, details.responseHeaders), {}, {
        'Content-Security-Policy': ["default-src 'self' https: data:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; connect-src 'self' https://generativelanguage.googleapis.com https://*.googleapis.com;"]
      })
    });
  });
